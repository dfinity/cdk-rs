...
Before you can build your project, you need to connect to the {IC} either running locally in your development environment or the decentralized {IC} mainnet.
...
. Stop the local {IC} running on your local computer by running the following command:
+
[source,bash]
----
dfx stop
