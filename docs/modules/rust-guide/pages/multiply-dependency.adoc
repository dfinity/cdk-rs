...
This ability to share and use functions defined in different smart contract canisters, even if the underlying smart contracts are written in different languages, is an important strategy for building dapps to run the {IC}.
...
You need to modify these default files and add some Rust-specific files to your project before you can build smart contract canisters that run on the {IC}.
...
Before you can build the project, you need to connect to the {IC} either running locally in your development environment or the {IC} mainnet.

To start the network locally:

. Check that you are still in the root directory for your project, if needed.
. Start the {IC} on your local computer in the background by running the following command:
+
[source,bash]
----
...
After you connect to the {IC} running locally in your development environment, you can register, build, and deploy your project locally.
