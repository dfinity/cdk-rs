...
* Deploy the smart contract canister on the local {IC} network.
...
Before you can build the `+rust_counter+` project, you need to connect to the {IC} network either running locally in your development environment or the decentralized {IC} mainnet.
